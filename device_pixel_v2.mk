...
$(call inherit-product-if-exists, vendor/lava/pixel_v2/pixel_v2-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/lava/pixel_v2/overlay
PRODUCT_PACKAGE_OVERLAYS += device/lava/pixel_v2/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/lava/pixel_v2
